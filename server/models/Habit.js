...
class Habit {
    ...
    static async create(habitData) {
        return new Promise (async (resolve, reject) => {
            try {
                let habits = await db.query(`INSERT INTO habits (username, name, description, frequency, color) VALUES ($1, $2, $3, $4, $5) RETURNING *;`,[habitData.username, habitData.name, habitData.description, habitData.frequency, habitData.color])
